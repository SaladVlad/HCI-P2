...
namespace NetworkService.Model
{
    public static class TextBoxBehavior
    {
        public static readonly DependencyProperty GotFocusCommandProperty =
            DependencyProperty.RegisterAttached("GotFocusCommand", typeof(ICommand), typeof(TextBoxBehavior), new PropertyMetadata(null, OnGotFocusCommandChanged));

        public static readonly DependencyProperty TextChangedCommandProperty =
            DependencyProperty.RegisterAttached("TextChangedCommand", typeof(ICommand), typeof(TextBoxBehavior), new PropertyMetadata(null, OnTextChangedCommandChanged));
